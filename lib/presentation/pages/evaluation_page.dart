...
class _EvaluationPageState extends ConsumerState<EvaluationPage> {
  ...
  Future<void> _calculateAndSave() async {
    ...
    try {
      ...
      _calories = BodyMetricsCalculator.calculateTDEE(weight, height, age, _gender, _activityLevel);
      ...
      await ref.read(metricsRepositoryProvider).saveProfile(
        UserProfile(
          id: user.id,
          height: height,
          age: age,
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(_weightController, 'Peso Actual (kg)', Icons.monitor_weight),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading 
                  ...
                  : const Text('Calcular Resultados', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Column(
              children: [
                Text('Tu clasificación es:', style: TextStyle(color: color, fontWeight: FontWeight.w500)),
                const SizedBox(height: 8),
                Text(
                  _classification,
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildResultItem('% Grasa', '${_bodyFat.toStringAsFixed(1)}%', Colors.blue),
                    _buildResultItem('Kcal/día', _calories.toStringAsFixed(0), Colors.orange),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildRecommendations() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Recomendaciones para ti', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
        const SizedBox(height: 16),
        _buildRecCard(Icons.restaurant, 'Dieta Sugerida', _getDietText()),
        const SizedBox(height: 12),
        _buildRecCard(Icons.directions_walk, 'Hábitos Saludables', _getHabitsText()),
      ],
    );
  }
  ...
  String _getDietText() {
    if (_bmi < 18.5) return 'Aumenta tu ingesta de proteínas y carbohidratos complejos. Consume frutos secos y grasas saludables.';
    if (_bmi < 25) return 'Mantén una dieta equilibrada rica en fibra, frutas y verduras. Prioriza proteínas magras.';
  ...
  String _getHabitsText() {
    if (_bmi < 25) return 'Realiza actividad física regular y asegúrate de dormir entre 7-8 horas diarias para mantener tu metabolismo.';
